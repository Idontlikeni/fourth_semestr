...
def test():
    ...
    assert obj.crack() == 'J3'   # D4
    assert obj.has_max_in_edges()
    obj.e(0)
    assert obj.paint() == 'J2'  # D2
    assert obj.crack() == "J1"  # D1
    assert obj.chain() == 'J5'  # D3
    assert obj.crack() == 'J5'  # D1
    assert obj.chain() == 'J5'  # D3
    assert obj.chain() == 'J2'  # D0
    assert obj.scale() == 'J3'  # D4
    obj.e(1)
    assert obj.paint() == 'J4'  # D4
    obj.e(0)
    assert obj.paint() == 'J2'  # D2
    assert obj.scale() == 'J0'  # D0
